...
at::Tensor sigmoid_focal_loss_forward_cuda(
  ...
  AT_DISPATCH_FLOATING_TYPES(logits.scalar_type(), "sigmoid_focal_loss_forward", [&] {
...
at::Tensor sigmoid_focal_loss_backward_cuda(
		const at::Tensor& logits,
                const at::Tensor& targets,
  ...
  AT_DISPATCH_FLOATING_TYPES(logits.scalar_type(), "sigmoid_focal_loss_backward", [&] {
