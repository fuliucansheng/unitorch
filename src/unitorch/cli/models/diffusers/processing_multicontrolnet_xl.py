...
from unitorch.models.diffusers import (
    MultiControlNetXLProcessor as _MultiControlNetXLProcessor,
)
...
class MultiControlNetXLProcessor(_MultiControlNetXLProcessor):
    def __init__(
        self,
        vocab1_path: str,
        merge1_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/process/diffusers/multicontrolnet_xl")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/process/diffusers/multicontrolnet_xl")
        pretrained_name = config.getoption(
            "pretrained_name", "stable-xl-base-multicontrolnet_xl-canny-depth"
        )
    ...
    @register_process("core/process/diffusers/multicontrolnet_xl/text2image")
    def _text2image(
        self,
        prompt: str,
    ...
    @register_process("core/process/diffusers/multicontrolnet_xl/text2image/inputs")
    def _text2image_inputs(
        self,
        prompt: str,
        condition_images: Union[Image.Image, str],
    ...
    @register_process("core/process/diffusers/multicontrolnet_xl/image2image/inputs")
    ...
    @register_process("core/process/diffusers/multicontrolnet_xl/inpainting/inputs")
