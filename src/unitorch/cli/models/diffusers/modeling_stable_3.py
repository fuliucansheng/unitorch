...
from unitorch.models.diffusers import (
    Stable3ForText2ImageGeneration as _Stable3ForText2ImageGeneration,
    Stable3ForImage2ImageGeneration as _Stable3ForImage2ImageGeneration,
    Stable3ForImageInpainting as _Stable3ForImageInpainting,
)
...
@register_model("core/model/diffusers/text2image/stable_3", diffusion_model_decorator)
class Stable3ForText2ImageGeneration(_Stable3ForText2ImageGeneration):
    def __init__(
        self,
        config_path: str,
...
class Stable3ForImage2ImageGeneration(_Stable3ForImage2ImageGeneration):
    def __init__(
        self,
        config_path: str,
        text_config_path: str,
...
class Stable3ForImageInpainting(_Stable3ForImageInpainting):
    def __init__(
        self,
        config_path: str,
        text_config_path: str,
    ...
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/model/diffusers/inpainting/stable_3")
        pretrained_name = config.getoption("pretrained_name", "stable-v3-medium")
        pretrained_infos = nested_dict_value(pretrained_stable_infos, pretrained_name)
