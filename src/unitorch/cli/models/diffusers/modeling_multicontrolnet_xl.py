...
from unitorch.cli.webuis import controlnet
from unitorch.models.diffusers import (
    MultiControlNetXLForText2ImageGeneration as _MultiControlNetXLForText2ImageGeneration,
    MultiControlNetXLForImage2ImageGeneration as _MultiControlNetXLForImage2ImageGeneration,
...
@register_model(
    "core/model/diffusers/text2image/multicontrolnet_xl", diffusion_model_decorator
)
class MultiControlNetXLForText2ImageGeneration(
    _MultiControlNetXLForText2ImageGeneration
):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/model/diffusers/text2image/multicontrolnet_xl")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/model/diffusers/text2image/multicontrolnet_xl")
        pretrained_name = config.getoption(
            "pretrained_name", "stable-xl-multicontrolnet-canny-depth"
        )
    ...
    @add_default_section_for_function(
        "core/model/diffusers/text2image/multicontrolnet_xl"
    )
    @autocast()
    def generate(
        self,
...
@register_model(
    "core/model/diffusers/image2image/multicontrolnet_xl", diffusion_model_decorator
)
class MultiControlNetXLForImage2ImageGeneration(
    _MultiControlNetXLForImage2ImageGeneration
):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/model/diffusers/image2image/multicontrolnet_xl")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section(
            "core/model/diffusers/image2image/multicontrolnet_xl"
        )
        pretrained_name = config.getoption(
            "pretrained_name", "stable-xl-multicontrolnet-canny-depth"
        )
...
@register_model(
    "core/model/diffusers/inpainting/multicontrolnet_xl", diffusion_model_decorator
)
class MultiControlNetXLForImageInpainting(_MultiControlNetXLForImageInpainting):
    def __init__(
        self,
        config_path: str,
        text_config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/model/diffusers/inpainting/multicontrolnet_xl")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/model/diffusers/inpainting/multicontrolnet_xl")
        pretrained_name = config.getoption(
            "pretrained_name", "stable-xl-multicontrolnet-canny-depth"
        )
        pretrain_infos = nested_dict_value(pretrained_diffusers_infos, pretrained_name)
    ...
    @add_default_section_for_function(
        "core/model/diffusers/inpainting/multicontrolnet_xl"
    )
    @autocast()
    def generate(
        self,
