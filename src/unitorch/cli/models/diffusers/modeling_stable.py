...
from unitorch.models.diffusers import (
    StableForImageGeneration as _StableForImageGeneration,
...
class StableForImageGeneration(_StableForImageGeneration):
    ...
    @classmethod
    @add_default_section_for_init("core/model/diffusion/stable/image")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/model/diffusion/stable/image")
        pretrained_name = config.getoption("pretrained_name", "ddpm-ema-pokemon-64")
        config_path = config.getoption("config_path", None)
        config_path = pop_value(
            config_path,
            nested_dict_value(pretrained_diffusers_infos, pretrained_name, "config"),
        )
        ...
        weight_path = pop_value(
            weight_path,
            nested_dict_value(pretrained_diffusers_infos, pretrained_name, "weight"),
            check_none=False,
        )
    ...
    @add_default_section_for_function("core/model/diffusion/stable/image")
    @autocast()
...
@register_model("core/model/diffusion/stable/text2image", diffusion_model_decorator)
class StableForText2ImageGeneration(_StableForText2ImageGeneration):
    ...
    @classmethod
    @add_default_section_for_init("core/model/diffusion/stable/text2image")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/model/diffusion/stable/text2image")
    ...
    @add_default_section_for_function("core/model/diffusion/stable/text2image")
    @autocast()
    def generate(
        self,
        input_ids: torch.Tensor,
