...
from unitorch.models.diffusers import (
    StableAdapterForText2ImageGeneration as _StableAdapterForText2ImageGeneration,
)
...
@register_model("core/model/diffusers/text2image/adapter", diffusion_model_decorator)
class StableAdapterForText2ImageGeneration(_StableAdapterForText2ImageGeneration):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/model/diffusers/text2image/adapter")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/model/diffusers/text2image/adapter")
        pretrained_name = config.getoption("pretrained_name", "stable-v1.5")
        pretrained_infos = nested_dict_value(pretrained_stable_infos, pretrained_name)

        pretrained_adapter_names = config.getoption(
            "pretrained_adapter_names", "stable-v1.5-adapter-canny"
        )
