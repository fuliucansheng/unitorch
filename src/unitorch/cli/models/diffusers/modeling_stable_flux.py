...
from unitorch.models.diffusers import (
    ...
    StableFluxForKontext2ImageGeneration as _StableFluxForKontext2ImageGeneration,
)
...
@register_model(
    "core/model/diffusers/kontext2image/stable_flux", diffusion_model_decorator
)
class StableFluxForKontext2ImageGeneration(_StableFluxForKontext2ImageGeneration):
    def __init__(
        self,
        config_path: str,
        text_config_path: str,
