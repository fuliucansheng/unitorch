...
from unitorch.models.diffusers import (
    DreamboothForText2ImageGeneration as _DreamboothForText2ImageGeneration,
)
...
class DreamboothForText2ImageGeneration(_DreamboothForText2ImageGeneration):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/model/diffusers/text2image/dreambooth")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/model/diffusers/text2image/dreambooth")
    ...
    @add_default_section_for_function("core/model/diffusers/text2image/dreambooth")
    @autocast()
    def generate(
        self,
        input_ids: torch.Tensor,
