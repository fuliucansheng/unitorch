...
class MistralForGeneration(_MistralForGeneration):
    ...
    def __init__(
        ...
        """
        Initialize the MistralForGeneration model.
    ...
    def from_core_configure(cls, config, **kwargs):
        """
        Create an instance of MistralForGeneration from a core configuration.
        ...
        Returns:
            MistralForGeneration: An instance of MistralForGeneration.
        """
    ...
    def forward(
        ...
        """
        Perform a forward pass on the MistralForGeneration model.
