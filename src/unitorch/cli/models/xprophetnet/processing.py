...
class XProphetNetProcessor(_XProphetNetProcessor):
    ...
    def __init__(
        ...
        """
        Initialize XProphetNetProcessor.
    ...
    def from_core_configure(cls, config, **kwargs):
        """
        Create an instance of XProphetNetProcessor from a core configuration.
        ...
        Returns:
            dict: The XProphetNetProcessor configuration.
        """
        ...
        vocab_path = pop_value(
            vocab_path,
            nested_dict_value(pretrained_xprophetnet_infos, pretrained_name, "vocab"),
        )
    ...
    @register_process("core/process/xprophetnet/generation/inputs")
    ...
    @register_process("core/process/xprophetnet/generation/labels")
    ...
    @register_process("core/process/xprophetnet/generation")
    def _generation(
        self,
        text: str,
    ...
    @register_process("core/postprocess/xprophetnet/detokenize")
    def _detokenize(
        self,
