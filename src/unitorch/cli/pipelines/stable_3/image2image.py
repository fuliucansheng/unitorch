...
class Stable3ForImage2ImageGenerationPipeline(GenericStable3Model):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/pipeline/stable_3/image2image")
    def from_core_configure(
        ...
        **kwargs,
        ...
        config.set_default_section("core/pipeline/stable_3/image2image")
    ...
    @torch.no_grad()
    @add_default_section_for_function("core/pipeline/stable_3/image2image")
    def __call__(
        self,
        text: str,
        image: Image.Image,
        ...
        if any(ckpt is not None for ckpt in controlnet_checkpoints) and any(
            ...
            #     tokenizer_3=None,
            # )
            raise "StableDiffusion3ControlNetImg2ImgPipeline is not implemented yet."
...
@register_script("core/script/stable_3/image2image")
class Stable3ForImage2ImageGenerationScript(GenericScript):
    ...
    def launch(self, **kwargs):
        ...
        config.set_default_section("core/script/stable_3/image2image")
