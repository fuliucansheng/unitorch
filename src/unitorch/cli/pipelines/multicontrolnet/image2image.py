...
class MultiControlNetForImage2ImageGenerationPipeline(
    _MultiControlNetForImage2ImageGeneration
):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/pipeline/multicontrolnet/image2image")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/pipeline/multicontrolnet/image2image")
    ...
    @torch.no_grad()
    @add_default_section_for_function("core/pipeline/controlnet/image2image")
    def __call__(
        self,
        text: str,
