...
class MistralLoraForGenerationPipeline(_MistralLoraForGeneration):
    def __init__(
        self,
        config_path: str,
        vocab_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/pipeline/peft/mistral/lora")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/pipeline/peft/mistral/lora")
        ...
        vocab_path = pop_value(
            vocab_path,
            nested_dict_value(pretrained_peft_infos, pretrained_name, "vocab"),
        )
