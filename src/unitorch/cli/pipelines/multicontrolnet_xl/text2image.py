...
class MultiControlNetXLForText2ImageGenerationPipeline(
    ...
    @classmethod
    @add_default_section_for_init("core/pipeline/multicontrolnet_xl/text2image")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/pipeline/multicontrolnet_xl/text2image")
