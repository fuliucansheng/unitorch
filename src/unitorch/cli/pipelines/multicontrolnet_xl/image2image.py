...
class MultiControlNetXLForImage2ImageGenerationPipeline(
    ...
    @classmethod
    @add_default_section_for_init("core/pipeline/multicontrolnet_xl/image2image")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/pipeline/multicontrolnet_xl/image2image")
    ...
    @torch.no_grad()
    @add_default_section_for_function("core/pipeline/multicontrolnet_xl/image2image")
    def __call__(
        self,
        text: str,
