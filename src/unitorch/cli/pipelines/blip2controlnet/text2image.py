...
from unitorch.models.diffusers import (
    Blip2ControlNetForText2ImageGeneration as _Blip2ControlNetForText2ImageGeneration,
)
...
class Blip2ControlNetForText2ImageGenerationPipeline(
    _Blip2ControlNetForText2ImageGeneration
):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/pipeline/blip2controlnet/text2image")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/pipeline/blip2controlnet/text2image")
    ...
    @torch.no_grad()
    @add_default_section_for_function("core/pipeline/blip2controlnet/text2image")
    def __call__(
        self,
        text: str,
        cond_image: Union[Image.Image, str],
        refer_text: str,
        ...
        inputs = self.processor.text2image_controlnet_inputs(
            text, cond_image, refer_text, refer_image
        )
