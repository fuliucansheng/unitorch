...
@register_script("core/script/stable_xl/inpainting")
class StableXLForImageInpaintingScript(GenericScript):
    ...
    def launch(self, **kwargs):
        ...
        pipe = StableXLForImageInpaintingPipeline.from_core_configure(config)

        config.set_default_section("core/script/stable_xl/inpainting")
