...
class StableXLForImage2ImageGenerationPipeline(GenericStableXLModel):
    def __init__(
        self,
        config_path: str,
...
@register_script("core/script/stable_xl/image2image")
class StableXLForImage2ImageGenerationScript(GenericScript):
    ...
    def launch(self, **kwargs):
        ...
        pipe = StableXLForImage2ImageGenerationPipeline.from_core_configure(config)

        config.set_default_section("core/script/stable_xl/image2image")
