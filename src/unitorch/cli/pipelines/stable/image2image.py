...
class StableForImage2ImageGenerationPipeline(GenericStableModel):
    def __init__(
        self,
        config_path: str,
...
@register_script("core/script/stable/image2image")
class StableForImage2ImageGenerationScript(GenericScript):
    ...
    def launch(self, **kwargs):
        ...
        pipe = StableForImage2ImageGenerationPipeline.from_core_configure(config)

        config.set_default_section("core/script/stable/image2image")
