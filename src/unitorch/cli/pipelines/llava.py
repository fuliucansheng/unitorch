...
class LlavaLlamaSiglipForGenerationPipeline(_LlavaLlamaSiglipForGeneration):
    ...
    @classmethod
    @add_default_section_for_init("core/pipeline/llava/llama_siglip")
    def from_core_configure(
        cls,
        config,
        pretrained_name: Optional[str] = None,
        ...
        **kwargs,
        ...
        config.set_default_section("core/pipeline/llava/llama_siglip")
        pretrained_name = pretrained_name or config.getoption(
    ...
    @torch.no_grad()
    @add_default_section_for_function("core/pipeline/llava/llama_siglip")
    def __call__(
        self,
        prompt: str,
        image: Union[str, Image.Image],
