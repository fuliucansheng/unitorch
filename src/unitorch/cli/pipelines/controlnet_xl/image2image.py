...
from unitorch.models.diffusers import ControlNetXLProcessor
...
class ControlNetXLForImage2ImageGenerationPipeline(
    _ControlNetXLForImage2ImageGeneration
):
    def __init__(
        self,
        config_path: str,
        ...
        self.processor = ControlNetXLProcessor(
    ...
    @classmethod
    @add_default_section_for_init("core/pipeline/controlnet_xl/image2image")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/pipeline/controlnet_xl/image2image")
        pretrained_name = config.getoption(
            "pretrained_name", "stable-v1.5-controlnet_xl-canny"
        )
    ...
    @torch.no_grad()
    @add_default_section_for_function("core/pipeline/controlnet_xl/image2image")
    def __call__(
        self,
        text: str,
