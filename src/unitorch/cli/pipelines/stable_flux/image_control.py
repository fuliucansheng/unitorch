...
class StableFluxForImageControlGenerationPipeline(GenericStableFluxModel):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/pipeline/stable_flux/image_control")
    ...
    @torch.no_grad()
    @add_default_section_for_function("core/pipeline/stable_flux/image_control")
    def __call__(
        self,
        text: str,
        image: Image.Image,
