...
class StableXLRefinerForText2ImageGenerationPipeline(
    _StableXLRefinerForText2ImageGeneration
):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/pipeline/stable_xl_refiner/text2image")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/pipeline/stable_xl_refiner/text2image")
    ...
    @torch.no_grad()
    @add_default_section_for_function("core/pipeline/stable_xl_refiner/text2image")
    def __call__(
        self,
        text: str,
        ...
        if self.refiner_pipeline is not None:
            self.refiner_pipeline.enable_freeu(*freeu_params)
        self.seed = seed
