...
class StableXLRefinerForImageInpaintingPipeline(_StableXLRefinerForImageInpainting):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/pipeline/stable_xl_refiner/inpainting")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("core/pipeline/stable_xl_refiner/inpainting")
