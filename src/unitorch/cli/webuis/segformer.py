...
from unitorch.cli.pipelines.segformer import SegformerForSegmentationPipeline
...
@register_webui("core/webui/segformer")
class SegformerWebUI(SimpleWebUI):
    ...
    def __init__(self, config: CoreConfigureParser):
        ...
        super().__init__(config, iname="Segformer", iface=iface)
