...
@register_webui("core/webui/blip")
class BlipCaptionWebUI(SimpleWebUI):
    ...
    def __init__(self, config: CoreConfigureParser):
        ...
        generate.click(
            self.generate, inputs=[image], outputs=[result], trigger_mode="once"
        )
        ...
        super().__init__(config, iname="Blip", iface=iface)
