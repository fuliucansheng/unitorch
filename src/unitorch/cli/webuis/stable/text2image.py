...
class StableText2ImageWebUI(SimpleWebUI):
    ...
    def __init__(self, config: CoreConfigureParser):
        ...
        height = create_element(
            "slider", "Image Height", min_value=1, max_value=2048, step=1, default=512
        )
        width = create_element(
            "slider", "Image Width", min_value=1, max_value=2048, step=1, default=512
        )
