...
from unitorch.cli.pipelines.stable_3.inpainting import Stable3ForImageInpaintingPipeline
...
class Stable3ImageInpaintingWebUI(SimpleWebUI):
    ...
    def start(self, pretrained_name, **kwargs):
        ...
        self._pipe = Stable3ForImageInpaintingPipeline.from_core_configure(
            self._config,
