...
class QWenImageEditingWebUI(SimpleWebUI):
    ...
    def __init__(self, config: CoreConfigureParser):
        ...
        super().__init__(config, iname="ImageEditing", iface=iface)
    ...
    def start(self, pretrained_name, **kwargs):
        ...
        self._pipe = QWenImageForImageEditingGenerationPipeline.from_core_configure(
            self._config,
