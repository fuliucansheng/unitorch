...
from unitorch.cli.pipelines.qwen_image import QWenImageForText2ImageGenerationPipeline
...
class QWenImageText2ImageWebUI(SimpleWebUI):
    ...
    def __init__(self, config: CoreConfigureParser):
        ...
        guidance_scale = create_element(
            "slider", "Guidance Scale", min_value=0, max_value=50, step=0.1, default=4.0
        )
    ...
    def start(self, pretrained_name, **kwargs):
        ...
        self._pipe = QWenImageForText2ImageGenerationPipeline.from_core_configure(
            self._config,
