...
class StableFluxImageReduxWebUI(SimpleWebUI):
    ...
    def __init__(self, config: CoreConfigureParser):
        ...
        super().__init__(config, iname="ImageRedux", iface=iface)
    ...
    def start(self, pretrained_name, **kwargs):
        ...
        self._pipe = StableFluxForImageReduxGenerationPipeline.from_core_configure(
            self._config,
