...
class Stable3ForImageInpaintingFastAPIPipeline(GenericStable3Model):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/fastapi/pipeline/stable_3/inpainting")
    ...
    @add_default_section_for_function("core/fastapi/pipeline/stable_3/inpainting")
    def __call__(
        self,
        text: str,
        image: Image.Image,
...
@register_fastapi("core/fastapi/stable_3/inpainting")
class Stable3ImageInpaintingFastAPI(GenericFastAPI):
    def __init__(self, config: CoreConfigureParser):
        self.config = config
        config.set_default_section(f"core/fastapi/stable_3/inpainting")
    ...
    def start(
        ...
        self._pipe = Stable3ForImageInpaintingFastAPIPipeline.from_core_configure(
            self.config,
