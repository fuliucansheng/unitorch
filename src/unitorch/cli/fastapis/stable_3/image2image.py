...
class Stable3ForImage2ImageFastAPIPipeline(GenericStable3Model):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/fastapi/pipeline/stable_3/image2image")
    def from_core_configure(
        ...
        **kwargs,
        ...
        config.set_default_section("core/fastapi/pipeline/stable_3/image2image")
...
@register_fastapi("core/fastapi/stable_3/image2image")
class Stable3Image2ImageFastAPI(GenericFastAPI):
    ...
    def start(
        ...
        self._pipe = Stable3ForImage2ImageFastAPIPipeline.from_core_configure(
            self.config,
