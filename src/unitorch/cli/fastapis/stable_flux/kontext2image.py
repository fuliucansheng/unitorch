...
class StableFluxForKontext2ImageFastAPIPipeline(GenericStableFluxModel):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/fastapi/pipeline/stable_flux/kontext2image")
    def from_core_configure(
        ...
        **kwargs,
        ...
        config.set_default_section("core/fastapi/pipeline/stable_flux/kontext2image")
    ...
    @add_default_section_for_function("core/fastapi/pipeline/stable_flux/kontext2image")
    def __call__(
        self,
        text: str,
        ...
        inputs = {
            **text_inputs,
            **{"kontext_pixel_values": kontext_inputs.pixel_values},
        }
        self.seed = seed
...
class StableFluxText2ImageFastAPI(GenericFastAPI):
    def __init__(self, config: CoreConfigureParser):
        self.config = config
        config.set_default_section(f"core/fastapi/stable_flux/kontext2image")
        router = config.getoption("router", "/core/fastapi/stable_flux/kontext2image")
        self._pipe = None
    ...
    def start(
        self,
        pretrained_name: Optional[str] = "stable-flux-dev-kontext",
        pretrained_lora_names: Optional[Union[str, List[str]]] = None,
        pretrained_lora_weights: Optional[Union[float, List[float]]] = 1.0,
        pretrained_lora_alphas: Optional[Union[float, List[float]]] = 32.0,
    ):
        self._pipe = StableFluxForKontext2ImageFastAPIPipeline.from_core_configure(
            self.config,
