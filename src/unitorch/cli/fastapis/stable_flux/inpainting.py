...
class StableFluxForImageInpaintingFastAPIPipeline(GenericStableFluxModel):
    ...
    @classmethod
    @config_defaults_init("core/fastapi/pipeline/stable_flux/inpainting")
    def from_config(
        cls,
        config,
    ...
    @config_defaults_method("core/fastapi/pipeline/stable_flux/inpainting")
    def __call__(
        self,
        text: str,
        image: Image.Image,
...
@register_fastapi("core/fastapi/stable_flux/inpainting")
class StableFluxImageInpaintingFastAPI(GenericFastAPI):
    def __init__(self, config: Config):
        self.config = config
        config.set_default_section(f"core/fastapi/stable_flux/inpainting")
    ...
    def start(
        ...
        self._pipe = StableFluxForImageInpaintingFastAPIPipeline.from_config(
            self.config,
