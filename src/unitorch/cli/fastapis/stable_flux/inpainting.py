...
class StableFluxForImageInpaintingFastAPIPipeline(GenericStableFluxModel):
    ...
    @classmethod
    @add_default_section_for_init("core/fastapi/pipeline/stable_flux/inpainting")
    def from_core_configure(
        ...
        **kwargs,
        ...
        pretrained_name = pretrained_name or config.getoption("pretrained_name", "stable-flux-dev-fill")
