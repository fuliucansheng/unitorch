...
class ControlNetXLForImageInpaintingFastAPIPipeline(GenericStableXLModel):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/fastapi/pipeline/controlnet_xl/inpainting")
    def from_core_configure(
        ...
        **kwargs,
        ...
        config.set_default_section("core/fastapi/pipeline/controlnet_xl/inpainting")
    ...
    @torch.no_grad()
    @add_default_section_for_function("core/fastapi/pipeline/controlnet_xl/inpainting")
    def __call__(
        self,
        text: str,
        image: Image.Image,
