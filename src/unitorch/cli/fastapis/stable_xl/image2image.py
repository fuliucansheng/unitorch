...
class StableXLForImage2ImageFastAPIPipeline(GenericStableXLModel):
    def __init__(
        self,
        config_path: str,
    ...
    @classmethod
    @add_default_section_for_init("core/fastapi/pipeline/stable_xl/image2image")
    def from_core_configure(
        ...
        **kwargs,
        ...
        config.set_default_section("core/fastapi/pipeline/stable_xl/image2image")
    ...
    @add_default_section_for_function("core/fastapi/pipeline/stable_xl/image2image")
    def __call__(
        self,
        text: str,
        image: Image.Image,
...
@register_fastapi("core/fastapi/stable_xl/image2image")
class StableXLImage2ImageFastAPI(GenericFastAPI):
    def __init__(self, config: CoreConfigureParser):
        self.config = config
        config.set_default_section(f"core/fastapi/stable_xl/image2image")
        router = config.getoption("router", "/core/fastapi/stable_xl/image2image")
    ...
    def start(
        ...
        self._pipe = StableXLForImage2ImageFastAPIPipeline.from_core_configure(
            self.config,
