...
from unitorch.models.chatglm.configuration_chatglm import ChatGLMConfig
...
CHATGLM_6B_INPUTS_DOCSTRING = r"""
    Args:
        ...
        position_ids (`torch.Tensor` of shape `({0})`, *optional*):
...
class ChatGLMForConditionalGeneration(ChatGLMPreTrainedModel):
    ...
    def _update_model_kwargs_for_generation(
        ...
        standardize_cache_format: Optional[bool] = False,
    ) -> Dict[str, Any]:
    ...
    def quantize(self, bits: int, empty_init=False, **kwargs):
        ...
        from unitorch.models.chatglm.quantization import quantize
