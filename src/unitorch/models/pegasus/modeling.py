...
@replace(transformers.models.pegasus.modeling_pegasus.PegasusAttention)
class PegasusAttentionV2(transformers.models.pegasus.modeling_pegasus.PegasusAttention):
    def __init__(
        self,
        embed_dim: int,
        num_heads: int,
