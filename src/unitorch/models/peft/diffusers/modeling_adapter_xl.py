...
class GenericStableXLAdapterLoraModel(GenericPeftModel, QuantizationMixin):
...
class StableXLAdapterLoraForText2ImageGeneration(GenericStableXLAdapterLoraModel):
    """
